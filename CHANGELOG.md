...
- `lore find docker logs` searches the library from the command line, and
  ...
  logs` works and a mistyped command searches rather than being refused. A
  broad search stops after ten matches and says how many more there are;
  `--all`, and piping into another program, print every one
...
[Unreleased]: https://github.com/alpcakin/lore/compare/v0.4.0...HEAD
[0.4.0]: https://github.com/alpcakin/lore/compare/v0.3.0...v0.4.0
[0.3.0]: https://github.com/alpcakin/lore/compare/v0.2.2...v0.3.0
